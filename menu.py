        ...
        if opcion=='1':
            ...
            if cliente:
                nombre=helpers.leer_texto(
                    2, 30, f"Nombre (2 a 30 char) [{cliente.nombre}]").capitalize()
                apellido=helpers.leer_texto(
                    2, 30, f"Apellido (2 a 30 char) [{cliente.apellido}]").capitalize()
                db.Clientes.modificar(cliente.dni, nombre, apellido)
                print('Cliente meodificado correctamente')
            else:
